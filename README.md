# [ngBoilerplate](http://joshdmiller.github.com/ng-boilerplate) [![Build Status](https://api.travis-ci.org/ngbp/ngbp.svg?branch=v0.3.2-release)](https://travis-ci.org/ngbp/ngbp)
